...
if uploaded_file is not None:
    ...
    # Fraud Rate by Hour of Day
    if option == "Fraud Rate by Hour of Day":
    ...
    # Fraud Rate by Daypart
    elif option == "Fraud Rate by Daypart":
    ...
    # Geolocation Heatmaps
    elif option == "Geolocation Heatmaps":
    ...
    # Correlation Heatmap
    elif option == "Correlation Heatmap of Temporal Features + Fraud Label":
    ...
    # Cluster-Based Profiling
    elif option == "Cluster-Based Profiling":
